# NeptuneResource - Claude Code Guide

## Site
- URL: https://neptuneresource.net
- Repo: https://github.com/corganb/neptuneresource
...
- Cloudflare Pages project name: `neptuneresource-site`
...
```
wrangler pages deploy public --project-name=neptuneresource-site --branch=main
```
